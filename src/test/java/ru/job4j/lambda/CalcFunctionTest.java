...
public class CalcFunctionTest {
    ...
    public void whenLinearFunctionThenLinearResults() {
        List<Double> result = CalcFunction.diapason(5, 9, x -> 2 * x + 1);
    ...
    public void whenQuadraticFunctionThenQuadraticResults() {
        List<Double> result = CalcFunction.diapason(5, 9, x -> Math.pow(x, 2) + 1);
    ...
    public void whenExponentialFunctionThenExponentialResults() {
        List<Double> result = CalcFunction.diapason(3, 7, x -> Math.pow(3, x) + 1);
